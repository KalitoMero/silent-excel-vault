...
const Home1 = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6 flex items-center justify-center">
      {/* Top right buttons */}
      ...
      <div className="w-full max-w-md">
        <Card className="shadow-xl border-0 bg-white/80 backdrop-blur-sm">
          <CardHeader>
            <CardTitle className="text-2xl text-center">Scan dein Auftrag</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <Input id="auftragsnummer" ref={inputRef} type="text" value={auftragsnummer} onChange={handleInputChange} onKeyDown={handleKeyDown} onBlur={handleBlur} className="text-lg py-6" placeholder="Scannen oder eingeben..." autoFocus />
              </div>
            </div>
          </CardContent>
        </Card>
